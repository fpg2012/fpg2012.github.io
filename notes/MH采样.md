...
如果 $x' = x$，那么除了正常的转移概率，还要加上转移到其他状态被拒绝的概率
...
我们可以简单阐述一下这个条件的意义。假设Markov链已经平稳，那么不管再怎么转移状态，都还是平稳分布。我们可以想象有一大堆粒子，按照平稳分布处于各个状态中，那么从一个状态a转移到另一个状态b的粒子个数，和从b转移到a的粒子个数应该一样多，否则就不平稳了。反过来，假如处于Markov链现在处于某个分布，从a到b的粒子数，等于从b到a的粒子数，那么这个分布在下一时刻也不会发生任何改变，因此是平稳分布。
